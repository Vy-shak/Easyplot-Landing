...
const Images = () => {
    return (
        <div className='flexBetween w-full pt-24 space-x-2 h-fit'>
            <Image alt='image1' className='w-36 h-fit rounded-md' src={Image1} />
            <Boxes length='w-14' box1='w-4' box2='w-8' box3='w-full' />
            <Image alt='image2' className='w-28 h-fit rounded-md' src={Image2} />
            <Boxes length='w-14' box1='w-4' box2='w-8' box3='w-full' />
            <Image alt='image3' className='w-40 h-fit rounded-md' src={Image3} />
            <Boxes length='w-14' box1='w-4' box2='w-8' box3='w-full' />
            <Image alt='image4' className='w-36 h-fit rounded-md' src={Image4} />
        </div>
    )
}
