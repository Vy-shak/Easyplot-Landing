...
const Navbar = () => {
    return (
        <section className='w-full box-border text-bluePrimary-700 h-12 max-w-screen fixed top-0 z-20   drop-shadow bg-white flexBetween font-semibold text-xs px-6'>
            <span>LOGO</span>
